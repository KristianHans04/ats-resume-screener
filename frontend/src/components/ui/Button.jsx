...
export default function Button({
  ...
  const variantClasses = {
    ...
    secondary: "dark:bg-white/10 bg-black/5 dark:border-white/10 border-black/5 dark:text-white text-black dark:hover:bg-white/20 hover:bg-black/10 active:scale-95",
    outline: "bg-transparent dark:border-white/20 border-black/10 dark:text-white text-black dark:hover:border-accent hover:border-accent dark:hover:text-accent hover:text-accent active:bg-accent/5",
    ghost: "bg-transparent border-transparent dark:text-gray-400 text-black/60 dark:hover:bg-white/5 hover:bg-black/5 dark:hover:text-white hover:text-black",
    danger: "dark:bg-red-500/10 bg-red-500/5 dark:border-red-500/20 border-red-500/10 dark:text-red-400 text-red-700 dark:hover:bg-red-500 hover:bg-red-500 hover:text-white active:bg-red-600"
  };
